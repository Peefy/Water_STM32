...
Last Write Time: 2016-03-27  16:07:04
***************************************************************/
...
///<The Datas to Send>//// 
#define S1_CUSTOM1     TemVal
#define TYPE_S1_C1     LC_Int16 
//#define S1_CUSTOM2     
//#define TYPE_S1_C2_DONOT_SEND
//#define S1_CUSTOM3     
...
#define f_COM_INIT         USART2_Init()   //Serial Port Initialize，格式要求：返回值为void，没有形参
#define f_SEND_BYTE(data)  USART_Send(data)   // 串 口 发 送 函 数，格式要求：返回值为void，形参为一个无符号8位整型
